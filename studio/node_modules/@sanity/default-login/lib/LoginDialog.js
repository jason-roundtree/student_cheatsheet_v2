...
class LoginDialog extends _react.default.Component {
  ...
  render() {
    ...
    if (error) {
      ...
      }, error.message, error.link && /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement("a", {
        href: error.link
      }, "Read more"))));
    }

    if (isLoaded && providers.length === 0) {
      return /*#__PURE__*/_react.default.createElement("div", null, "No providers configured");
    }

    if (isLoaded && !shouldRedirect) {
      return /*#__PURE__*/_react.default.createElement(_loginDialogContent.default, {
        title: title,
