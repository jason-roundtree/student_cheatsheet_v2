...
var _DocumentStatusBar = require("../components/DocumentStatusBar");
...
var _DocumentActionShortcuts = require("../components/DocumentActionShortcuts");
...
var _DocumentOperationResults = require("../components/DocumentOperationResults");
...
class DocumentPane extends _react.default.PureComponent {
  ...
  getInitialValue() {
    ...
    return value ? base : _objectSpread({}, base, {}, this.props.initialValue);
  }
...
_defineProperty(DocumentPane, "contextType", _.PaneRouterContext);
