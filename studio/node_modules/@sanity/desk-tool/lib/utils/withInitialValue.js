...
var withInitialValue = Pane => {
  var WithInitialValueStream = (0, _reactPropsStream.streamingComponent)(props$ => props$.pipe((0, _operators.switchMap)(props => {
    ...
    (0, _operators.debounceTime)(25), (0, _operators.switchMap)(document => {
      ...
      return (0, _rxjs.merge)((0, _rxjs.of)({
        ...
        if (resolveError) {
          return (0, _rxjs.of)( /*#__PURE__*/_react.default.createElement(_ErrorPane.default, null, /*#__PURE__*/_react.default.createElement("h2", null, "Failed to resolve initial value"), /*#__PURE__*/_react.default.createElement("p", null, "Check developer console for details")));
        }

        var title = documentType && "New ".concat(_schema.default.get(documentType).title || documentType);
        return (0, _rxjs.of)(isResolving ? /*#__PURE__*/_react.default.createElement(_LoadingPane.default, _extends({}, props, {
          title: title,
  ...
  var WithInitialValueWrapper = props => /*#__PURE__*/_react.default.createElement(_.PaneRouterContext.Consumer, null, context => /*#__PURE__*/_react.default.createElement(WithInitialValueStream, _extends({}, props, {
    paneContext: context
  })));
...
function resolvePaneOptions(props, templateName, document) {
  ...
  return hasDefinedType ? options : _objectSpread({}, options, {
    type: documentType
  });
}
