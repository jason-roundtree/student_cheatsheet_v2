...
(0, _storybook.storiesOf)('[tool] Desk tool', module).addDecorator(_knobs.withKnobs).add('Confirm Delete', () => {
  ...
  var props = {
    badges,
    actions,
    historyStatus: historyStatus ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, historyStatus) : null,
  ...
  }), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_index.default, props)));
  ...
  var props = {
    actions,
    historyStatus: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "Updated just now"),
    idPrefix: 'storybook-desk-tool',
    // eslint-disable-next-line no-console
    onHistoryStatusClick: () => console.log('onHistoryStatusClick')
  };
