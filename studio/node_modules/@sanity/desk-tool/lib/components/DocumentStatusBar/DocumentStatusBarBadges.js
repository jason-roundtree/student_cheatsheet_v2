...
function DocumentStatusBarBadgesInner(props) {
  ...
  }, props.states.map((badge, i) => /*#__PURE__*/_react.default.createElement(_default.default, {
    key: i,
    color: badge.color,
    title: badge.title
  }, badge.label)));
...
function DocumentStatusBarBadges(props) {
  ...
  return badges ? /*#__PURE__*/_react.default.createElement(_utils.RenderBadgeCollectionState, {
