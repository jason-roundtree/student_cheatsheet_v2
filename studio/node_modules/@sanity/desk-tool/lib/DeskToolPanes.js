  ...
  renderPanes() {
    ...
    return paneGroups.reduce((components, group, index) => {
      ...
      group.map((sibling, siblingIndex) => {
        ...
        }, /*#__PURE__*/_react.default.createElement(_index.PaneRouterContext.Provider, {
          value: paneRouterContext
        }, pane === _index.LOADING_PANE ? /*#__PURE__*/_react.default.createElement(_LoadingPane.default, {
        ...
        }) : /*#__PURE__*/_react.default.createElement(_Pane.default, _extends({
          key: paneKey // Use key to force rerendering pane on ID change
          ,
          paneKey: paneKey,
          index: i,
