...
function HistoryRestoreAction(_ref) {
  ...
  return {
    ...
    dialog: !error && isConfirmDialogOpen && {
      type: 'confirm',
      color: 'danger',
      onCancel: onComplete,
      onConfirm: () => {
      ...
      message: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("strong", null, "Are you sure"), " you want to restore this document?")
    } || error && {
      type: 'error',
