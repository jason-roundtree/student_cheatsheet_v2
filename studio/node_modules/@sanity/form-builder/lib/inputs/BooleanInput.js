...
class BooleanInput extends _react.default.Component {
  constructor() {
    super(...arguments);
    ...
    _defineProperty(this, "handleChange", event => {
      this.props.onChange(_PatchEvent.default.from((0, _PatchEvent.set)(event.currentTarget.checked)));
    });
  ...
  render() {
    ...
    return isCheckbox ? /*#__PURE__*/_react.default.createElement(_checkbox.default, {
      readOnly: readOnly,
      onChange: this.handleChange,
      checked: value,
      ref: this.setInput,
      description: type.description
    }, type.title) : /*#__PURE__*/_react.default.createElement(_switch.default, {
      readOnly: readOnly,
      checked: value,
      label: type.title,
      description: type.description,
