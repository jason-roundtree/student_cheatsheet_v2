...
class Editor extends _react.default.Component {
  constructor(_props) {
    ...
    _defineProperty(this, "handlePaste", (event, editor, next) => {
      ...
      return resolved.then(result => {
        ...
        if (result && result.insert) {
          var allowedDecorators = this.props.blockContentFeatures.decorators.map(item => item.value);
          var blocksToInsertNormalized = result.insert.map(block => (0, _blockTools.normalizeBlock)(block, {
            allowedDecorators
          }));
          var patches = [(0, _PatchEvent.setIfMissing)(blocksToInsertNormalized), this.props.value && this.props.value.length !== 0 ? (0, _PatchEvent.insert)(blocksToInsertNormalized, 'after', result.path || focusPath) : (0, _PatchEvent.set)(blocksToInsertNormalized, [])];
    ...
    _defineProperty(this, "renderNode", props => {
      ...
      switch (node.type) {
        case 'contentBlock':
          return /*#__PURE__*/_react.default.createElement(_ContentBlock.default, {
        ...
        case 'span':
          return /*#__PURE__*/_react.default.createElement(_Span.default, {
            attributes: props.attributes,
            blockContentFeatures: blockContentFeatures,
            editor: props.editor,
            markers: markers,
        ...
        default:
          return /*#__PURE__*/_react.default.createElement(ObjectClass, {
            attributes: props.attributes,
            blockContentFeatures: blockContentFeatures,
            editor: props.editor,
    ...
    _defineProperty(this, "renderMark", props => {
      ...
      return decorator ? /*#__PURE__*/_react.default.createElement(_Decorator.default, props) : null;
    });
  ...
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement(_BlockExtrasOverlay.default, {
      blockContentFeatures: blockContentFeatures,
