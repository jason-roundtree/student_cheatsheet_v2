...
function ListItemOnEnterKeyPlugin() {
  ...
  return {
    ...
    onKeyDown(event, editor, next) {
      ...
      var isList = startBlock && startBlock.data && startBlock.data.get('listItem');
      ...
      var previousBlock = document.getPreviousBlock(selection.start.key);
      ...
      if (!previousBlock) {
        ...
        if (startBlock.text === '') {
          var newData = startBlock.data.toObject();
      ...
      var blockToInsert = defaultBlock; // If level is > 1, insert a blank list element with the sublevel below
      ...
      var nextBlock = document.getNextBlock(selection.start.key);
