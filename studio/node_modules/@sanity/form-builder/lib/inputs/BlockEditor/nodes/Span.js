...
class Span extends _react.default.Component {
  ...
  render() {
    ...
    annotationTypes.forEach(annotation => {
      ...
      if (CustomComponent) {
        children = /*#__PURE__*/_react.default.createElement(CustomComponent, annotations[annotation.value], children);
      }
    });
    ...
    if (annotationTypes.length === 0) {
      ...
      }), children, /*#__PURE__*/_react.default.createElement(_InvalidValueInput.default, {
