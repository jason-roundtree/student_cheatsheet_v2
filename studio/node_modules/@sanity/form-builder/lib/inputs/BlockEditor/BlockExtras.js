...
class BlockExtras extends _react.default.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: (0, _classnames.default)([_BlockExtras.default.root, fullscreen && _BlockExtras.default.hasFullScreen, errors.length > 0 && _BlockExtras.default.withError, warnings.length > 0 && !errors.length && _BlockExtras.default.withWarning])
