...
class PrimaryGroup extends _react.default.PureComponent {
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement(_BlockStyleSelect.default, {
      className: _PrimaryGroup.default.blockStyleSelect,
      blockContentFeatures: blockContentFeatures,
      editor: editor,
      editorValue: editorValue
    })), blockContentFeatures.decorators.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
      className: _PrimaryGroup.default.group
    }, /*#__PURE__*/_react.default.createElement(_DecoratorButtons.default, {
      collapsed: collapsedGroups.indexOf('decoratorButtons') >= 0,
      blockContentFeatures: blockContentFeatures,
      editor: editor,
      editorValue: editorValue
    })), blockContentFeatures.lists.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
      className: _PrimaryGroup.default.group
    }, /*#__PURE__*/_react.default.createElement(_ListItemButtons.default, {
      collapsed: collapsedGroups.indexOf('listItemButtons') >= 0,
      blockContentFeatures: blockContentFeatures,
      editor: editor,
      editorValue: editorValue
    })), blockContentFeatures.annotations.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
      className: _PrimaryGroup.default.group
    }, /*#__PURE__*/_react.default.createElement(_AnnotationButtons.default, {
    ...
    })), insertItems.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
      className: _PrimaryGroup.default.group
...
_defineProperty(PrimaryGroup, "defaultProps", {
  isPopped: false,
  isMobile: false
});