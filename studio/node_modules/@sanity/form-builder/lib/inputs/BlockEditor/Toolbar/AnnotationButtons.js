...
function getIconFromItem(item) {
  return item.icon || (0, _get2.default)(item, 'blockEditor.icon') || (0, _get2.default)(item, 'type.icon') || (0, _get2.default)(item, 'type.to.icon') || (0, _get2.default)(item, 'type.to[0].icon');
}
...
class AnnotationButtons extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderAnnotationButton", item => {
      ...
      return /*#__PURE__*/_react.default.createElement(_ToolbarClickAction.default, {
        onAction: onAction,
        editor: editor,
  ...
  render() {
    ...
    var Icon;
    var icon = getIconFromItem(items[0]);
