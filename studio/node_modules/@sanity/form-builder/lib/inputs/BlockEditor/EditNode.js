...
class EditNode extends _react.default.Component {
    ...
    _defineProperty(this, "handleChange", patchEvent => {
      ...
      _patchEvent.patches.forEach((patch, index) => {
        if (patch.path.length === 3 && patch.path[1] === 'markDefs' && patch.type === 'unset') {
          var block = value && value.find(blk => blk._key === (0, _getKey.getKey)(patch.path[0]));

          var _block = _objectSpread({}, block);

          var markKey = (0, _getKey.getKey)(patch.path[2]);
  ...
  renderInput() {
    ...
    }, /*#__PURE__*/_react.default.createElement(_FormBuilderInput.FormBuilderInput // @ts-ignore (fixme: this is another type than the FormBuilderInput expects - turn into an common interface instead)
    , {
      type: type,
      level: 0,
  ...
  render() {
    var nodeValue = this.props.nodeValue;

    if (!nodeValue) {
      return /*#__PURE__*/_react.default.createElement("div", null, "No value???");
    }

    return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_stacked.default, null, isActive => /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_escapable.default, {
