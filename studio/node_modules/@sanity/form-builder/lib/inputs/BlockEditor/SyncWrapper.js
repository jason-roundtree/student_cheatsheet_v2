...
function isDeprecatedBlockValue(value) {
  ...
  var block = value.find(item => item && item._type === 'block');
...
var _default = (0, _withPatchSubscriber.default)((_temp = _class = class SyncWrapper extends _react.default.Component {
  constructor(_props) {
    ...
    _defineProperty(this, "handleChangeSet", changeSet => {
      var isRemote = changeSet.isRemote,
          selection = changeSet.selection,
          callback = changeSet.callback;
      var operations = changeSet.operations; // Add undo step for local changes

      if (!isRemote && !operations.some(op => op.__isUndoRedo) && !operations.every(op => op.type === 'set_selection') && !operations.every(op => op.type === 'set_value') && !operations.every(op => op.type === 'set_node' && op.properties && op.properties.data && op.properties.data.get('placeholder'))) {
    ...
    this.patchToOperations = (0, _createPatchToOperations.default)(this._blockContentFeatures, type); // @ts-ignore
  ...
  componentDidUpdate(prevProps) {
    ...
    var changed = prevProps.value !== this.props.value;
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, !isDeprecated && !invalidBlockValue && /*#__PURE__*/_react.default.createElement(_Input.default, {
      ...
      value: value
    }), invalidBlockValue && /*#__PURE__*/_react.default.createElement(_InvalidValueInput.default, {
    ...
    }), isDeprecated && /*#__PURE__*/_react.default.createElement(_default2.default, {
      label: type.title
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: _SyncWrapper.default.disabledEditor
    }, /*#__PURE__*/_react.default.createElement("strong", null, "Heads up!"), /*#__PURE__*/_react.default.createElement("p", null, "You're using a new version of the Studio with", deprecatedSchema && " a block schema that hasn't been updated.", deprecatedSchema && deprecatedBlockValue && ' Also block text needs to be updated.', deprecatedBlockValue && !deprecatedSchema && " block text that hasn't been updated."), deprecatedSchema === 'deprecatedInline' && /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement("a", {
      href: (0, _generateHelpUrl.default)('migrate-to-block-inline-types'),
      rel: "noopener noreferrer",
      target: "_blank"
    }, "Migrate schema to block.children inline types")), deprecatedSchema === 'deprecatedSpan' && /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement("a", {
