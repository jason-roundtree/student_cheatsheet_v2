  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_default.default, {
      ...
      if (!optionType) {
        ...
        }, "Invalid option type: Type ", /*#__PURE__*/_react.default.createElement("code", null, actualType), " not valid for array of [", validTypes.join(', '), "]. Check the list options of this field");
      }
