  ...
  return new Promise((resolve, reject) => {
    ...
    xhr.onload = () => {
      ...
      reader.onloadend = () => {
        ...
        resolve(dataURLtoFile(reader.result, filename || "".concat((0, _uuid.default)(), ".").concat(ext)));
      };
...
function base64ToFile(base64Data, filename) {
  return new Promise((resolve, reject) => {
    ...
    resolve(dataURLtoFile(base64Data, filename || "".concat((0, _uuid.default)(), ".").concat(ext)));
  });
}
