...
class ImageInput extends _react.default.PureComponent {
  ...
  renderAdvancedEdit(fields) {
    ...
    return /*#__PURE__*/_react.default.createElement(_fullscreen.default, {
      ...
      isOpen: true
    }, this.isImageToolEnabled() && value && value.asset && /*#__PURE__*/_react.default.createElement(_WithMaterializedReference.default, {
  ...
  render() {
    ...
    }, uploadProps), uploadError && /*#__PURE__*/_react.default.createElement(_default3.default, {
      kind: "error",
      isPersisted: true,
      actionTitle: "OK",
    ...
    }, "Remove"))), highlightedFields.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
