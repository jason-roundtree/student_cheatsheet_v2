...
function uploadImage(file, options) {
  var upload$ = (0, _assets.uploadImageAsset)(file, options).pipe((0, _operators.filter)(event => event.stage !== 'download'), (0, _operators.map)(event => _objectSpread({}, event, {
    ...
    if (event.type === 'complete') {
      ...
      }, ['asset']), (0, _patches.set)(100, [_constants.UPLOAD_STATUS_KEY, 'progress'])]);
    }
