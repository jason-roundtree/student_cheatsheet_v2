...
function Document(props) {
  ...
  var stylesheets = props.stylesheets.map(item => /*#__PURE__*/_react.default.createElement("link", {
    key: item.path,
    rel: "stylesheet",
    href: assetUrl(staticPath, item)
  }));
  var subresources = props.scripts.map(item => /*#__PURE__*/_react.default.createElement("link", {
    key: item.path,
    rel: "subresource",
    href: assetUrl(staticPath, item)
  }));
  ...
  var favicons = props.favicons.map((item, index) => /*#__PURE__*/_react.default.createElement("link", {
    key: item.path,
    rel: "icon",
    href: assetUrl(staticPath, item)
  }));
  ...
  }), stylesheets, subresources, favicons), /*#__PURE__*/_react.default.createElement("body", {
    id: "sanityBody"
