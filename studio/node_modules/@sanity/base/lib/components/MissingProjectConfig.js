...
function MissingProjectConfig() {
  ...
  return /*#__PURE__*/_react.default.createElement(_fullscreen.default, {
    ...
    size: "medium",
    padding: "none"
  }, /*#__PURE__*/_react.default.createElement("p", null, "The ", /*#__PURE__*/_react.default.createElement("code", null, "sanity.json"), " file in your studio folder seems to be missing the", ' ', missing.join(' and '), " configuration ", missing.length > 1 ? 'options ' : 'option ', "under the ", /*#__PURE__*/_react.default.createElement("code", null, "api"), " key."), /*#__PURE__*/_react.default.createElement("p", null, "A valid ", /*#__PURE__*/_react.default.createElement("code", null, "sanity.json"), " file looks something like the following:"), /*#__PURE__*/_react.default.createElement("pre", null, /*#__PURE__*/_react.default.createElement("code", null, highlightMissing(JSON.stringify(desiredConfig, null, 2))))));
