...
var _HotspotImage = _interopRequireDefault(require("./styles/HotspotImage.css"));
...
var HotspotImage = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function HotspotImage() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HotspotImage)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(HotspotImage, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "".concat(_HotspotImage.default.root, " ").concat(className),
        style: style,
...
_defineProperty(HotspotImage, "propTypes", {
  ...
  hotspot: _propTypes.default.object.isRequired,
