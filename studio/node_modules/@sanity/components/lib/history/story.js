...
(0, _storybook.storiesOf)('History').addDecorator(_knobs.withKnobs).add('List', () => {
  ...
  }, (0, _knobs.boolean)('children', false, 'test') && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_default.default, {
    inverted: true,
    color: "white",
    padding: "small"
  }, "Publish"), /*#__PURE__*/_react.default.createElement(_default.default, {
    kind: "simple",
    padding: "small"
  }, "Discard"))));
});