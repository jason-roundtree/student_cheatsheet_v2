...
class ConfirmDialog extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "handleAction", (action, event) => {
...
_defineProperty(ConfirmDialog, "propTypes", {
  ...
  cancelColor: _propTypes.default.oneOf(['primary', 'success', 'danger', 'white']),
  confirmColor: _propTypes.default.oneOf(['primary', 'success', 'danger', 'white']),
