...
var _default = _interopRequireDefault(require("part:@sanity/components/textareas/default"));
...
(0, _storybook.storiesOf)('Text areas').addDecorator(_knobs.withKnobs).add('Default', () => {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    rows: (0, _knobs.number)('rows', 2, 'props'),
