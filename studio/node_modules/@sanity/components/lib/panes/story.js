...
class AutoCollapseTest extends _react.default.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_splitController.default, {
      ...
      }, /*#__PURE__*/_react.default.createElement("div", null, "Colapsed: ", pane.isCollapsed ? 'true' : 'false'), /*#__PURE__*/_react.default.createElement("div", null, "DefaultSize: ", pane.defaultSize), /*#__PURE__*/_react.default.createElement("div", null, "MinSize: ", pane.minSize))));
    }));
  }
...
(0, _storybook.storiesOf)('Panes').addDecorator(_knobs.withKnobs).add('Pane', () => {
  ...
  }, /*#__PURE__*/_react.default.createElement(AutoCollapseTest, {
