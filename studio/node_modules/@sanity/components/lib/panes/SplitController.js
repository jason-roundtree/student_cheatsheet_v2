  ...
  constructor() {
    ...
    _defineProperty(this, "renderSplitPane", (pane1, pane2) => {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: "\n          ".concat(_SplitController.default.vertical, "\n          ").concat(isResizing ? _SplitController.default.splitWrapperResizing : _SplitController.default.splitWrapper, "\n          ").concat(pane2 ? '' : _SplitController.default.singleWrapper, "\n          ").concat(isCollapsed ? _SplitController.default.isCollapsed : _SplitController.default.notCollapsed, "\n        ")
