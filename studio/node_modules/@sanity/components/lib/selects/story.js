...
() => {
  ...
  var hasOnclear = (0, _knobs.boolean)('has onClear', false, 'test');
  ...
  var hasItems = (0, _knobs.boolean)('hasItems', false, 'test') || undefined;
  var selectedItem = items && items[selected] || undefined;
  return /*#__PURE__*/_react.default.createElement("div", {
    style: _objectSpread({
      minWidth: '320px'
    }, centerStyle)
  ...
  }, /*#__PURE__*/_react.default.createElement(_searchable.default, {
    label: (0, _knobs.text)('label', 'This is the label', 'props'),
    placeholder: (0, _knobs.text)('placeholder', 'This is the placeholder', 'props'),
    onChange: (0, _storybook.action)('onChange'),
    onFocus: (0, _storybook.action)('onFocus'),
