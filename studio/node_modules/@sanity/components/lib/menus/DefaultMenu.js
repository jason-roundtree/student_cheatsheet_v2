...
class DefaultMenu extends _react.default.Component {
  static getDerivedStateFromProps(props) {
    ...
    var targets = hasUngrouped ? [ungrouped].concat(groups) : groups;
  ...
  constructor(props) {
    ...
    _defineProperty(this, "handleKeyDown", event => {
      ...
      var items = this.state.items.filter(item => !item.isDisabled);
      var currentIndex = items.indexOf(focusedItem) || 0;
