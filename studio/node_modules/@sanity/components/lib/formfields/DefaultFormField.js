...
class DefaultFormField extends _react.default.PureComponent {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    var showValidationMessages = this.state.showValidationMessages;
    var levelClass = "level_".concat(level);
    return /*#__PURE__*/_react.default.createElement("div", {
      className: "\n          ".concat(inline ? _defaultStyle.default.inline : _defaultStyle.default.block, "\n          ").concat(_defaultStyle.default[levelClass] || '', "\n          ").concat(wrapped ? _defaultStyle.default.wrapped : '', "\n          ").concat(className || '')
    ...
    }, label && /*#__PURE__*/_react.default.createElement(_default.default, {
      ...
      contentClassName: _defaultStyle.default.validationList,
      animateOpacity: true
