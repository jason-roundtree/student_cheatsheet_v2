...
var _SnackbarItem = _interopRequireDefault(require("./styles/SnackbarItem.css"));
...
class SnackbarItem extends _react.default.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "DEFAULT_ICONS", {
    ...
    this._snackRef = _react.default.createRef();
  }
  ...
  render() {
    var _this$props6 = this.props,
        ...
        id = _this$props6.id,
        isCloseable = _this$props6.isCloseable,
    ...
    }, /*#__PURE__*/_react.default.createElement(_default.default // eslint-disable-next-line react/jsx-handler-names
    , {
...
_defineProperty(SnackbarItem, "propTypes", {
  ...
  icon: _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.node, _propTypes.default.bool]),
  isCloseable: _propTypes.default.bool,
  isOpen: _propTypes.default.bool.isRequired,
  isPersisted: _propTypes.default.bool,
  ...
  onSetHeight: _propTypes.default.func,
  setAutoFocus: _propTypes.default.bool
});

_defineProperty(SnackbarItem, "defaultProps", {
  action: undefined,
