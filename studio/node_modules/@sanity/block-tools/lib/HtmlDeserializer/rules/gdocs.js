...
var blocks = _objectSpread({}, _constants.HTML_BLOCK_TAGS, {}, _constants.HTML_HEADER_TAGS);
  ...
  return [{
    deserialize(el, next) {
      if ((0, _helpers.tagName)(el) === 'span' && isGoogleDocs(el)) {
        var span = _objectSpread({}, _constants.DEFAULT_SPAN, {
          marks: [],
          text: el.innerText
        });
    ...
    deserialize(el, next) {
      if ((0, _helpers.tagName)(el) === 'li' && isGoogleDocs(el)) {
        return _objectSpread({}, _constants.DEFAULT_BLOCK, {
