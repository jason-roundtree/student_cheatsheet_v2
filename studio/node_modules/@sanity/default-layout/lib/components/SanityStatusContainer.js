...
class SanityStatusContainer extends _react.default.PureComponent {
  ...
  render() {
    ...
    var outdated = this.props.versionReply.outdated;
    var level = levels[getHighestLevel(outdated || [])];
    return /*#__PURE__*/_react.default.createElement(_SanityStatus.default, _extends({}, this.props.versionReply, {
      level: level,
...
var _default = (0, _reactPropsStream.withPropsStream)(_user.default.currentUser.pipe((0, _operators.flatMap)(event => event.user && event.user.role === 'administrator' ? _versionChecker.default.checkVersions().then((_ref) => {
