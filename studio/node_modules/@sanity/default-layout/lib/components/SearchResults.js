...
var _SearchResults = _interopRequireDefault(require("./styles/SearchResults.css"));
...
class SearchResults extends _react.default.Component {
  ...
  componentDidUpdate(prevProps) {// NOTE: Disabled because `{block: 'nearest'}` is not supported by all browsers
