...
var fse = require('fs-extra'); // Try to load .env files from the current directory
// eslint-disable-next-line no-process-env


var env = process.env.SANITY_ACTIVE_ENV || process.env.NODE_ENV || 'development';
dotenv.config({
  path: path.join(process.cwd(), ".env.".concat(env))
});
