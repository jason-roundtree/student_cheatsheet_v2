...
var addCorsOrigin = require('../../actions/cors/addCorsOrigin');
...
var _default = {
  ...
  action: function () {
    var _action = _asyncToGenerator(function* (args, context) {
      ...
      var isFile = yield fse.pathExists(path.join(process.cwd(), origin));

      if (isFile) {
        output.warn("Origin \"".concat(origin, "?\" Remember to quote values (sanity cors add \"*\")"));
      }

      var success = yield addCorsOrigin(origin, flags, context);
