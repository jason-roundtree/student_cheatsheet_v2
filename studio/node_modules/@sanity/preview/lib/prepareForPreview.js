...
function defaultPrepare(value) {
  return Object.keys(value).reduce((acc, fieldName) => {
    return _objectSpread({}, acc, {
      [fieldName]: (0, _portableText.isPortableTextArray)(value[fieldName]) ? (0, _portableText.extractTextFromBlocks)(value[fieldName]) : value[fieldName]
    });
  }, {});
}
