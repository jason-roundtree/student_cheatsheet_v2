...
class AssetHandler {
  constructor(options) {
    ...
    _defineProperty(this, "findAndModify", /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator(function* (item, action) {
        ...
        if (isAsset && action === ACTION_REWRITE) {
          ...
          if (isModernAsset(assetId)) {
            ...
            var _filePath = "".concat(assetType, "s/").concat(generateFilename(assetId));

            return _objectSpread({
              _sanityAsset: "".concat(assetType, "@file://./").concat(_filePath)
            }, (yield _this.findAndModify(other, action)));
          } // Legacy asset


          var type = _this.assetsSeen.get(assetId) || (yield _this.lookupAssetType(assetId));
          var filePath = "".concat(type, "s/").concat(generateFilename(assetId));
          return _objectSpread({
            _sanityAsset: "".concat(type, "@file://./").concat(filePath)
          }, (yield _this.findAndModify(other, action)));
        }
    ...
    _defineProperty(this, "lookupAssetType", /*#__PURE__*/function () {
